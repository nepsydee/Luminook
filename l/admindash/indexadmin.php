    ...
    ?></span>
           ...
           <li> 
                <a href='../author/book.php'>
                    ...
                    <span class="ic"><ion-icon name="caret-down"></ion-icon></span>
                </a>
            </li>
...
<tr>
    ...
    <td><a href="../cruds/update.php?id=<?php echo $row['id']; ?>"><span id="green"><ion-icon name="create-outline"></ion-icon></span></a> | <a onclick="return window.confirm('Are you sure you want to delete this user?')" href="../cruds/delete.php?id=<?php echo $row['id']; ?>"><span id="red"><ion-icon name="trash-bin-outline"></ion-icon></span></a></td>
</tr>
<?php
}
?>

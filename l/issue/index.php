...
<body>
   ...
   <div class="detail">
    ...
    <form id="myForm"  method="POST" action="insertdata.php">
        <div class="cardhead">
            <h2>Issue Details</h2>
            <a href='indexuser.php' class="btnn"> Borrow <span id="ic"><ion-icon name="caret-up"></ion-icon></span></a>
        </div>
<table>
    <br>
    <br>
<thead class='tab'>
<tr>
<td> <label for="role" id="role">Added By</label></td>
<td> <label for="name">Name</label></td>
<td> <label for="email">Email</label></td>
<td> <label for="book">Book Name</label></td>
<td><label for="qan">Borrowed Quantity</label></td>
<td><label for="qan">Borrowed Date</label></td>
</tr>
</thead>
<tbody>
        <tr>
            <td> <select id="role" name="role">
            <option value="libraria">Librarian</option>
        <option value="admin">Admin</option>
       </select></td>
            <td><input type="text" id="name" name="name" required></td>
            <td><input type="email" id="email" name="email" required></td>
            <td><input type="text" id="book" name="book" required min="0" max="2"></td>
            <td> <input type="number" id="quantity" name="qan" required min="1" max="3"></td>
